-- 2 - Quais os três mecânicos ativos com o maior número de ordens de serviço concluídas nos últimos 3 meses, considerando apenas serviços com valor superior a R$ 100?
...
-- Cria a stored procedure para 3 mecânicos
...
-- Executar a procedure para 3 mecânicos
EXEC sp_Top3MecanicosProdutivos;

-- SE PRECISAR EXCLUIR PROCEDURE!
